...
export interface ApiBlogListingBlogListing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    feature_image_desktop: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    feature_image_mobile: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiContactFormSubmissionContactFormSubmission
  ...
  info: {
    displayName: 'contact_form_ submission';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email_id: Schema.Attribute.Email;
...
export interface ApiHeaderAndFooterHeaderAndFooter
  extends Struct.SingleTypeSchema {
  collectionName: 'header_and_footers';
  info: {
    displayName: 'Header&Footer';
    pluralName: 'header-and-footers';
    singularName: 'header-and-footer';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_section: Schema.Attribute.Component<'footer.footer-0', false>;
    header_section: Schema.Attribute.Component<'header.header', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
